...
./.venv/bin/pytest                                    # schema validity tests
./.venv/bin/black tests/ && ./.venv/bin/ruff check tests/   # Python format + lint
npx prettier@3.3.3 --check "**/*.{json,md}" --ignore-path .prettierignore  # JSON/Markdown formatting
```
